...
const faqdata: FaqData[] = [
	...
	},
	{
		...
		subheading: [
			`You don't need an account to play on Evolution Server, but for a complete experience, we recommend registering. In addition to automatic ranking you'll gain access to more content and special events.`,
		],
	},
	{
		heading: "3. How does ranking work?",
		subheading: [
			"No matter which game mode you play, you will earn points for each victory. The more points you accumulate, the higher your rank will be. You can check your rank on the website; the website only displays the top 20 ranks. If you are not in the top 20, you can find your rank in your profile.",
		],
	},
];
...
const Faq = () => {
	return (
		<div className="my-20 px-6" id="faq-section">
			...
			<p className="text-center lg:text-lg font-normal text-bluish">New to Evolution Server? Here is a list of common questions that you can review.<br />If you have any other questions, feel free to communicate with us on our Discord</p>
										...
										{({ open }) => (
											<>
												...
												<Disclosure.Panel className="px-4 pt-4 pb-2 md:text-lg text-bluish font-normal opacity-50">
													{items.subheading.map((element, index) => (
